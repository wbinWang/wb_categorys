...
+ (UIImage *)wb_animatedGIFWithData:(NSData *)data withGifAniFinishBlock:(void(^)(NSTimeInterval))block
{
    ...
    if (count <= 1) {
        ...
        for (size_t i = 0; i < count; i++) {
            ...
            duration += [self wb_frameDurationAtIndex:i source:source];
...
+ (float)wb_frameDurationAtIndex:(NSUInteger)index source:(CGImageSourceRef)source {
...
//        
//        if (data) {
//            return [UIImage wb_animatedGIFWithData:data];
//        }
//        
